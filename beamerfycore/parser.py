        ...
        with open(self.tex_file) as file:
            ...
            for line in lines:
                ...
                if line.startswith('%beamerfy:'):
                    ...
                    elif command == 'beamer-title':
                        beamerfy_dict['title']       = beamerfy_syntax[len(command):].strip()
                    elif command == 'beamer-author':
                        beamerfy_dict['author']      = beamerfy_syntax[len(command):].strip()
